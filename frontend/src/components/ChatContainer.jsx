    ...
    <div className="flex-1 flex flex-col overflow-auto">
      ...
      <div className='flex-1 overflow-y-auto p-4 space-y-4'>
        {messages.map((message)=>{
          return <div key ={message._id} className={`chat ${message.senderId === authUser._id?"chat-end":"chat-start"}`} ref ={messageEndRef}>
            ...
            <div className='chat-bubble flex flex-col'>
              {message.image && <img src={message.image} alt='message' className="sm:max-w-[200px] rounded-md mb-2"/>}
